...
<head>
  ...
  <link rel="stylesheet" href="style/requestformstyle.css" type="text/css" />
...
<body>
  ...
  <form class="form-horizontal" method="post" action="requestforminuser.php ">
    <fieldset style="    width: 98%;">

      <!-- Form Name -->
      <legend class="aa">Patient Request </legend>
      <div class="image">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <button id="signup" name="signup" class="btn btn-success" style="color:white;background:#ff7e7d;border:none;width:477px;height: 47px;">Sign Up</button>
          </div>
        </div>

...
<body>
  ...
  <form class="form-horizontal" method="post" action="requestformin.php ">
    <fieldset style="    width: 98%;">
      ...
      <div class="image">
        ...
        <div class="form-group">
          ...
          <div class="col-md-4">
            <button id="signup" name="signup" class="btn btn-success" style="color:white;background:#ff7e7d;border:none;    width: 389px;">Sign Up</button>
          </div>
        </div>
